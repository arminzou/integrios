...
This parent directory separates the source-verification values available to Ingestion from the
...
- [`source/`](./source/README.md) contains source-verification values for Ingestion.
