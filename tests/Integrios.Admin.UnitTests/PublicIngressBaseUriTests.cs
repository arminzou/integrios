...
public sealed class PublicIngressBaseUriTests
{
    [Fact]
    public void Parse_ProductionRejectsHttp()
    {
        var exception = Assert.Throws<InvalidOperationException>(() =>
            PublicIngressBaseUri.Parse("http://ingress.example.test/root", allowHttp: false));
    ...
    {
        PublicIngressBaseUri uri = PublicIngressBaseUri.Parse(
    ...
    {
        Assert.Throws<InvalidOperationException>(() => PublicIngressBaseUri.Parse(value, allowHttp: false));
    }
}
