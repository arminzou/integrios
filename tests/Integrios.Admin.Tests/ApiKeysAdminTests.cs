...
public sealed class ApiKeysAdminTests : IClassFixture<AdminApiFixture>, IAsyncLifetime
{
    ...
    public async Task GetApiKey_ReturnsKey_WithKeyPrefix()
    {
        ...
        var body = await response.Content.ReadFromJsonAsync<ApiKeyResponse>(WebJson);
        Assert.NotNull(body);
    ...
    public async Task ListApiKeys_ReturnsCreatedKeys()
    {
        ...
        var body = await response.Content.ReadFromJsonAsync<ApiKeyListResponse>(WebJson);
        Assert.NotNull(body);
    ...
    public async Task ListApiKeys_Pagination_WorksCorrectly()
    {
        ...
        var body1 = await page1.Content.ReadFromJsonAsync<ApiKeyListResponse>(WebJson);
        ...
        var body2 = await page2.Content.ReadFromJsonAsync<ApiKeyListResponse>(WebJson);
    ...
    public async Task RevokeApiKey_Returns200_AndKeyIsDisabled()
    {
        ...
        var body = await getResponse.Content.ReadFromJsonAsync<ApiKeyResponse>(WebJson);
        Assert.NotNull(body);
    ...
    private async Task<CreateApiKeyResponse> CreateApiKeyAsync(string name)
    {
