...
public sealed class WorkerRouteMatchingTests : IClassFixture<WorkerRoutingFixture>, IAsyncLifetime
{
    private readonly WorkerRoutingFixture fixture;

    public WorkerRouteMatchingTests(WorkerRoutingFixture fixture)
    {
