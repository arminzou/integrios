...
{
    public void Configure(EntityTypeBuilder<TenantApiKey> entity)
    {
        entity.HasKey(e => e.Id).HasName("tenant_api_keys_pkey");

        entity.ToTable("tenant_api_keys");

        entity.HasAlternateKey(e => e.KeyPrefix).HasName("tenant_api_keys_key_prefix_key");

        entity.HasIndex(e => e.KeyHash, "idx_tenant_api_keys_key_hash").IsUnique();

        entity.HasIndex(e => e.TenantId, "idx_tenant_api_keys_tenant_id");
