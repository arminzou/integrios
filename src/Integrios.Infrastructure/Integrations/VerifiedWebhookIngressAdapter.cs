...
// raw body before parsing, then derive delivery identity and Event type from data the Integration
    ...
    : IIngressSourceAdapter
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        string eventType = $"{context.IntegrationKey}.{eventTypeSegment}";
