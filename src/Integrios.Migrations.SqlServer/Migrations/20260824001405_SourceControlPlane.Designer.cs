...
namespace Integrios.Migrations.SqlServer.Migrations
{
    ...
    [Migration("20260824001405_SourceControlPlane")]
    partial class SourceControlPlane
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("events", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_events_source_connection_required", "source_connection_id IS NOT NULL");
                        });
                    ...
                    b.ToTable("subscriptions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_subscriptions_transform_config_json", "transform_config IS NULL OR ISJSON(transform_config, VALUE) = 1");
                        });
                });
            ...
            modelBuilder.Entity("Integrios.Domain.Entities.SubscriptionDelivery", b =>
                {
                    ...
                    b.Property<string>("TransformConfigSnapshot")
                        .HasColumnType("nvarchar(max)")
                    ...
                    b.ToTable("subscription_deliveries", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_subscription_deliveries_http_execution_snapshot_json", "ISJSON(http_execution_snapshot, VALUE) = 1");
                            ...
                            t.HasCheckConstraint("ck_subscription_deliveries_transform_config_snapshot_json", "transform_config_snapshot IS NULL OR ISJSON(transform_config_snapshot, VALUE) = 1");
                        });
                });
            ...
            modelBuilder.Entity("Integrios.Domain.ValueObjects.TopicSource", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("tenant_id");
            ...
            modelBuilder.Entity("Integrios.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasOne("Integrios.Domain.ValueObjects.TopicSource", null)
                        .WithMany()
