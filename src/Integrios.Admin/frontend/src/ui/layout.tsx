...
///
/// A list with no rows gets none of this. The reserve is for a selection that is about to happen,
/// and "Select a Connector" over a list holding no Connectors asks for something the screen cannot
/// give — so screens render it only where there is a row to select.
