...
internal sealed record PublicIngestionBaseUri
{
    internal const string ConfigurationKey = "Integrios:PublicIngestionBaseUri";

    public Uri Value { get; }

    private PublicIngestionBaseUri(Uri value)
    {
        Value = value;
    }

    internal static PublicIngestionBaseUri Parse(string? configuredValue, bool allowHttp)
    {
        ...
        return new PublicIngestionBaseUri(uri);
    }
